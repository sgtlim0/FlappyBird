...
export const BASE_PIPE_GAP = 170
export const MIN_PIPE_GAP = 120
export const BASE_PIPE_SPEED = 2.3
export const MAX_PIPE_SPEED = 4.5
export const GRAVITY = 0.42
export const FLAP_FORCE = -7.2
export const BIRD_SIZE = 28
export const BASE_PIPE_SPAWN_INTERVAL = 1700
export const MIN_PIPE_SPAWN_INTERVAL = 1000
